...
urlpatterns = patterns('',
    # Examples:
    url(r'^$','finance.users.views.login', name='login'),
    url(r'^editprofile/$','finance.users.views.editprofile', name='editprofile'),
    url(r'^changepw/$','finance.users.views.changepw', name='changepw'),
    #url(r'^event/(?P<foobar>.+)/$','finance.views.event', name='events'),
    url(r'^createUser/', 'finance.users.views.createUser', name='create'),
    url(r'^logout/', 'finance.users.views.logout', name='logout'),
    ...
    url(r'^reimbursement/$', 'finance.views.reimbursement', name='reimbursement'),
